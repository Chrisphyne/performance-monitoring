...
export declare const MaterialArrayLayoutRenderer: ({ visible, enabled, id, uischema, schema, label, rootSchema, renderers, cells, data, path, errors, addItem }: ArrayLayoutProps) => JSX.Element;
